	...
	return function() {
		return {
			...
			onBeforeTemplateCustomizationLoaded: function (wizModel, tmplModel) {
				shared.modifyModelMobile(wizModel, tmplModel, "3worklistodatav4");
				shared.modifyModelExternally(tmplModel, "3worklistodatav4");
			...
			onBeforeTemplateGenerate: function (templateZip, model) {
				model["3worklistodatav4"].parameters.ApplicationNamespace.value = model["3worklistodatav4"].parameters.ApplicationNamespace.value + "." + model.projectName;
				...
				shared.modifyModelNavigationHack(model, "3worklistodatav4");
				shared.modifyModelAddEnvironment(model, "3worklistodatav4");
				shared.modifyNeoWelcomeFile(model, "3worklistodatav4");
			...
			onAfterGenerate: function (projectZip, model) {
				if (model["3worklistodatav4"].parameters.Object_Identifier.value.type === "Edm.Int32") {
					shared.modifyController(projectZip, model, "webapp/controller/Worklist.controller.js");
				}

				var sObjectTitle = model["3worklistodatav4"].parameters.Object_Identifier.value.name;
				...
				shared.modifyZipFLP(projectZip, model, "3worklistodatav4");
			...
			_setDatabindingForLayoutEditor: function (oContext, oModel) {
				var templateName = "3worklistodatav4";
