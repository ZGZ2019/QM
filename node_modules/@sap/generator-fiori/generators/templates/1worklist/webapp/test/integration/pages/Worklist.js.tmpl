	...
	Opa5.createPageObjects({
		...
		onTheWorklistPage : {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("{{1worklist.parameters.ObjectCollection_Key.value.name}}"),
								name: oBindingContext.getProperty("{{1worklist.parameters.Object_Identifier.value.name}}")
							};
						}
					}));
				},
			...
			assertions: Object.assign({
				...
				},{{#if 1worklist.parameters.Object_Number.value.name}}
