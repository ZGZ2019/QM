			...
			actions : {
				...
				iRememberTheListItem : function (oListItem) {
					...
					this.getContext().currentItem = {
						...
						id: oBindingContext.getProperty("{{2listdetail.parameters.ObjectCollection_Key.value.name}}"),
						title: oBindingContext.getProperty("{{2listdetail.parameters.Object_Identifier.value.name}}")
					};
				}
			},
